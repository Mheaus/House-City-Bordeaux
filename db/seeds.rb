...
flats = [
  {
    ...
    rooms: [
      {name: "outdoor", description: "La maison peut accueillir de 2 à 8 personnes est une dépendance située au fond du jardin de la propriétaire, la terrasse cloturée sépare les 2 maisons.", photos: [
      ...
      {name: "living", description: "Grand salon/salle à manger ensoleillé donnant sur la terrasse (canapé convertible 2 places, table basse, meuble Tv, grand écran plat, table pour manger)", photos: [
      ...
      {name: "kitchen", description: "Cuisine américaine toute équipée : réfrigérateur, four, micro-onde, plaque à induction, lave-vaisselle, grille pain, machine à café, assortiments de vaisselles et de verres.", photos: [
      ...
      {name: "bedroom1", description: "Suite parentale : lit 2 places 160×200, tables de chevet, dressing, salle de bain et douche tout confort.", photos: [
      ...
      {name: "bedroom2", description: "A l’étage une chambre mansardée : 2 lits d'une place 90x200 modulable pour un lit de 2 personnes.", photos: [
      ...
      {name: "bedroom3", description: "Mezzanine avec lit 2 places 140x200 avec vue sur le salon (pouvant faire office de salle de jeu , coin détente, bureau...)", photos: [
          "http://res.cloudinary.com/mathieuadbrt/image/upload/v1509988568/hcb/42_rue-Binaud/chambre6.jpg",
          "http://res.cloudinary.com/mathieuadbrt/image/upload/v1509988568/hcb/42_rue-Binaud/living4.jpg"
        ]},
      {name: "bathroom_dressing", description: "2 Salles d’eau et toilettes, un dressing et une machine à laver", photos: [
